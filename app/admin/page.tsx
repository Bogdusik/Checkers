                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      {u.isAdmin && <Shield className="w-3 h-3 text-blue-400" />}
                    </div>
                  </div>
                  ...
                  {users.map((u, index) => (
                    ...
                    >
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-2">
                          <span className="text-white font-medium text-sm">{u.username}</span>
                          {u.isAdmin && <Shield className="w-4 h-4 text-blue-400" />}
                        </div>
                      </td>
                      <td className="py-4 px-4">
                      ...
                      <td className="py-4 px-4 text-center text-white text-sm">{u.statistics?.totalGames || 0}</td>
                      <td className="py-4 px-4 text-center text-green-400 font-semibold text-sm">{u.statistics?.wins || 0}</td>
                      <td className="py-4 px-4 text-center text-red-400 font-semibold text-sm">{u.statistics?.losses || 0}</td>
                      <td className="py-4 px-4 text-center text-yellow-400 font-semibold text-sm">{u.statistics?.draws || 0}</td>
                      <td className="py-4 px-4 text-gray-400 text-sm">{formatDate(u.lastLoginAt)}</td>
                    </motion.tr>
                  ))}
                </tbody>
              </table>
