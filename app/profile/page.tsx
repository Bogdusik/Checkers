        ...
        >
          ...
          <div className="mt-6 flex gap-4">
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all transform hover:scale-105 text-center"
            >
              Найти игру
            </button>
            <button
              onClick={handleLogout}
              className="flex items-center gap-2 px-6 py-3 glass-dark text-white rounded-lg hover:bg-opacity-50 transition-all"
            >
